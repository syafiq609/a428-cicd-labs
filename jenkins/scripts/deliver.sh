...
echo 'Now...'
echo 'Visit http://localhost:30000 to see your Node.js/React application in action.'
echo '(This is why you specified the "args ''-p 30000:30000''" parameter when you'
